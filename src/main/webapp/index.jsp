...
<body>
    <header>
        <h1>Sriram Nishanth - DevOps Engineer</h1>
    ...
    <section id="about" class="about">
        <h2>About Me</h2>
        <p>Hello! I'm Sriram Nishanth, a DevOps Engineer passionate about optimizing workflows and delivering scalable, automated solutions. I specialize in tools like Jenkins, Docker, Kubernetes, Terraform, and cloud platforms such as AWS and Azure.</p>
    </section>
    ...
    <footer>
        <p>© 2024 Sriram Nishanth | DevOps Engineer Portfolio | <a href="#about">Back to Top</a></p>
    </footer>
</body>
</html>
